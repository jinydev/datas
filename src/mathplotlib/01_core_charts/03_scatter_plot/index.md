...
> - [📥 scatter_plot_practice.ipynb 파일 다운로드](./scatter_plot_practice.ipynb) (클릭 또는 마우스 우클릭 후 '다른 이름으로 링크 저장')
...
## [실습 1] Seaborn의 `scatterplot` 기본 그리기
...
## [실습 2] `hue`: Seaborn 최고의 마법 (3차원 정보 파악)
...
## [실습 3] 더 나아가기: 점의 크기(`size`)와 버블 차트
