---
layout: mathplotlib
title: "5.3.2 선 그래프 (Line Plot)와 시계열 데이터"
---

## 5.3.2 선 그래프 (Line Plot)와 신뢰 구간의 마법

앞서 배운 5.1.2장에서는 단순히 점 5개를 잇는 기본적인 `plt.plot()`을 배웠습니다. 
...
산점도(Scatter Plot)가 두 점 사이의 관계를 나타낸다면, 선 그래프(Line Plot)는 데이터가 시간에 따라 어떻게 변해가는지 그 **추세(Trend)**를 한눈에 보여줍니다. 주식 차트, 환율 변동, 기온 변화 등 연속적인 흐름을 그릴 때 반드시 사용해야 합니다.

---

### ② Seaborn `lineplot`의 숨겨진 힘: 신뢰 구간
