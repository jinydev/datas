...
![Step 1 데이터 구조 개념도](img/step1_superstore_data.svg)
...
> ---  ------        --------------  -----  
>  0   Order Date    1000 non-null   str    
>  1   Category      1000 non-null   str    
>  2   Sub-Category  1000 non-null   str    
...
> 1  2022-01-01 17:30:48.648648       Technology  ...  1551.85 -159.53
> 2  2022-01-02 11:01:37.297297        Furniture  ...  1594.90 -246.74
> 3  2022-01-03 04:32:25.945945  Office Supplies  ...  1523.47 -121.23
> 4  2022-01-03 22:03:14.594594  Office Supplies  ...  1286.13  526.79
> 
> [5 rows x 6 columns]
> ```
...
![Step 2 데이터 정제 개념도](img/step2_groupby_logic.svg)
...
> Sales    Profit
> Category                            
> Furniture        188472.67  23756.67
> Office Supplies  603497.57  92147.16
> Technology       214994.38  35773.71
> ```
...
![Step 3 시각화 개념도](img/step3_scatter_loss_leader.svg)
...
* **결론:** 마트가 고객을 끌어모으기 위해 거대한 가구(Furniture) 등을 원가 이하로 폭탄 세일하여 팔고 있는 결제 건들이 다수 존재함을 알 수 있습니다. 이런 미끼 상품(Loss Leader) 전략이 도를 넘으면 회사 전체의 이익을 깎아 먹게 됩니다.

---

## Step 4: 카테고리별 최종 수익 비교 막대그래프 (Barplot)

![Step 4 상관관계 분석 개념도](img/step4_barplot_roi.svg)
...
### 💡 코드 딥다이브 & 인사이트 (매우 중요!)
* **전자기기(Technology) & 사무용품(Office Supplies):** 막대가 높게 치솟아 있습니다. 특히 사무용품 부서가 회사의 살림을 책임지는 효자(캐시카우)입니다.
* **가구(Furniture):** 막대가 다른 부서에 비해 가장 낮습니다. 거대한 매출 규모에도 불구하고, 잦은 할인과 적자 결제 건들 때문에 전체 수익성이 바닥을 칩니다. 사장님은 이 차트를 보는 즉시 가구 부서장에게 할인율 축소 정책이나 재고 관리 원가 절감 방안을 명령할 것입니다. 이것이 데이터 분석이 비즈니스를 움직이는 힘입니다.
