---
layout: practice
title: "178. 과학 실험 보고서 서술형 정밀 평가 실습"
permalink: /practice/178_science_report_grades/
---

# 178. 과학 실험 보고서 서술형 정밀 평가 실습
## 실전 데이터 분석 178: 레포트 구성 요소 완결성 대비 최종 취득 학점 편차

![도입 만화](img/intro_comic.png)

### 📊 실습 개요 (Tutorial Overview)
본 실습은 실제 비즈니스 및 학계에서 자주 마주하는 과학 실험 보고서 서술형 정밀 평가를 주제로 다룹니다.
...
# 데이터 로드
df = pd.read_csv('../csv_data/science_report_grades.csv')
print(df.info())
print(df.head())
```
...
> 
>    ReportID  FormulaCount  ReferenceCount  PlagiarismRatio_Percent  ReportGrade  PeerReviewScore
0   1780001          86.0           107.9                     45.0         93.5              8.1
1   1780002         100.7            83.0                     42.8         73.5              8.0
2   1780003         121.3            86.1                     57.1         75.2              5.2
3   1780004         122.8            97.7                     56.5         78.3              6.5
4   1780005         126.2            78.1                     57.1        114.1              7.2
> ```
...
> 💡 **[분석 도메인 통계 지식 한눈에 보기]**
> 본 실습은 과학 실험 보고서 서술형 정밀 평가를 판독하기 위한 의사결정 프레임워크를 제공합니다.
