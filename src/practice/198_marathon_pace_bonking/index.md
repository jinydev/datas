---
layout: practice
title: "198. 마라톤 페이스 오버페이스와 페이스 메이커 실습"
permalink: /practice/198_marathon_pace_bonking/
---

# 198. 마라톤 페이스 오버페이스와 페이스 메이커 실습

> **📥 [실습 주피터 노트북(.ipynb) 다운로드](practice.ipynb)**
## 실전 데이터 분석 198: 마라톤 생리학적 에너지 고갈(Bonking) 리스크 회귀 분석

![도입 만화](img/intro_comic.png)

### 📊 실습 개요 (Tutorial Overview)
본 실습은 실제 비즈니스 및 학계에서 자주 마주하는 마라톤 페이스 오버페이스와 페이스 메이커를 주제로 다룹니다.
...
memory usage: 47.0 KB
> 
>    RunnerID  HalfPassTimeMinutes  FinishTimeMinutes  PaceDropRatio_Percent  HydrationStationsPassed  Bonked
0   1980001                 14.1               29.0                   73.1                     30.2    90.1
1   1980002                 47.9               18.4                   43.0                     63.5   101.1
2   1980003                  5.5                4.7                   38.2                     56.2    88.7
3   1980004                  1.0               27.6                   59.4                     50.9    60.0
4   1980005                  8.5                2.5                   27.2                     26.3   143.7
> ```
...
> 💡 **[분석 도메인 통계 지식 한눈에 보기]**
> 본 실습은 마라톤 페이스 오버페이스와 페이스 메이커를 판독하기 위한 의사결정 프레임워크를 제공합니다.
