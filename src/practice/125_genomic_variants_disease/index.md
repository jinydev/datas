---
layout: practice
title: "125. 유전자 변이(SNP) 발현 및 질환 매핑 실습"
permalink: /practice/125_genomic_variants_disease/
---

# 125. 유전자 변이(SNP) 발현 및 질환 매핑 실습
## 실전 데이터 분석 125: 유전적 감수성과 환경 기저 요인의 상관관계

![도입 만화](img/intro_comic.png)

### 📊 실습 개요 (Tutorial Overview)
본 실습은 실제 비즈니스 및 학계에서 자주 마주하는 유전자 변이(SNP) 발현 및 질환 매핑를 주제로 다룹니다.
...
# 데이터 로드
df = pd.read_csv('../csv_data/genomic_variants_disease.csv')
print(df.info())
print(df.head())
```
...
> 
>    SubjectID  MutatedAllelesCount  GeneExpressionLevel  EnvironmentalScore   Age  DiseaseOnset
0    1250001                 82.5                 92.7                10.0  31.0             0
1    1250002                100.3                 93.2                 9.7  60.0             0
2    1250003                 76.3                 99.0                 6.8  48.0             1
3    1250004                108.2                 65.7                 8.3  58.0             1
4    1250005                107.9                140.4                 7.4  12.0             1
> ```
...
> 💡 **[분석 도메인 통계 지식 한눈에 보기]**
> 본 실습은 유전자 변이(SNP) 발현 및 질환 매핑를 판독하기 위한 의사결정 프레임워크를 제공합니다.
