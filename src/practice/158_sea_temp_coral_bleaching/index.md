---
layout: practice
title: "158. 해수면 온도(SST) 상승 및 산호초 백화 실습"
permalink: /practice/158_sea_temp_coral_bleaching/
---

# 158. 해수면 온도(SST) 상승 및 산호초 백화 실습
## 실전 데이터 분석 158: 해양 기후 위기 생물 다양성 산호 군집 생존 모형

![도입 만화](img/intro_comic.png)

### 📊 실습 개요 (Tutorial Overview)
본 실습은 실제 비즈니스 및 학계에서 자주 마주하는 해수면 온도(SST) 상승 및 산호초 백화를 주제로 다룹니다.
...
# 데이터 로드
df = pd.read_csv('../csv_data/sea_temp_coral_bleaching.csv')
print(df.info())
print(df.head())
```
...
> 
>    ReefSectorID  SeaTempAnomaly  OceanAcidity_pH  CoralBleachingRatio_Percent  DepthMeters  SevereBleaching
0       1580001           161.9             75.8                         57.3          7.7                1
1       1580002           185.1            104.6                         28.9         23.9                0
2       1580003           142.1             86.9                         59.5         25.9                0
3       1580004           136.8             81.3                         46.0         25.6                0
4       1580005           157.0             80.3                         27.1          9.7                1
> ```
...
> 💡 **[분석 도메인 통계 지식 한눈에 보기]**
> 본 실습은 해수면 온도(SST) 상승 및 산호초 백화를 판독하기 위한 의사결정 프레임워크를 제공합니다.
