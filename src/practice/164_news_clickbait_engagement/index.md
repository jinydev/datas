...
# 데이터 로드
df = pd.read_csv('./news_clickbait_engagement.csv')
print(df.info())
print(df.head())
```
...
> None
>    ArticleID  SensationalismScore  ...  ShareCount  IsClickbait
> 0    1640001                  5.1  ...        63.3         99.9
> 1    1640002                  5.7  ...       116.2         88.5
> 2    1640003                  8.4  ...       161.9         86.6
> 3    1640004                  6.4  ...       104.2         78.0
> 4    1640005                 10.0  ...       101.7         84.2
> 
> [5 rows x 6 columns]
> ```
