...
# 데이터 로드
df = pd.read_csv('./dam_inflow_power.csv')
print(df.info())
print(df.head())
```
...
> None
>      DamID  WaterInflowRate  ...  TurbineEfficiency_Percent  FloodWarningTriggered
> 0  1840001             45.1  ...                       53.9                      0
> 1  1840002             33.5  ...                       60.2                      1
> 2  1840003             36.3  ...                       34.9                      1
> 3  1840004             42.7  ...                       37.7                      1
> 4  1840005             73.5  ...                       37.3                      1
> 
> [5 rows x 6 columns]
> ```
