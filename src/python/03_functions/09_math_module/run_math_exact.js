...
// From line 54 (index 53) to line 85 (index 84)
const idx_start = 53;
const idx_end = 84;

const new_content = \`### 제곱근(\`sqrt\`)과 강력한 거듭제곱(\`pow\`)
...
console.log("Success: Sliced lines 54-85 and injected new math content!");
