...
description: "본 장에서는 남들이 피땀 흘려 만들어 놓은 코드를 재사용하는 '모듈(Module)'과 '라이브러리(Library)'의 짜릿한 개념을 비유를 통해 아주 직관적으로 확립합니다. 그리고 파이썬 기본 탑재 모듈 중 하나인 math를 내 코드로 당겨와(import), 직접 짜기 힘..."
---
