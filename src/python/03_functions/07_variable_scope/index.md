---
layout: python
title: "3.3.7 변수의 유효 범위 (Scope와 Global)"
description: "본 장에서는 함수 내부 코드와 바깥세상을 엄격히 철창으로 가로막는 메모리 방화벽인 '변수의 유효 범위(Scope)' 개념을 익힙니다. 굳게 닫힌 밀실 문을 부수고 전 지역을 통치하는 global 키워드의 작동 원리와 그 치명적인 위험성을 함께 파악합니다."
---
...
![Local vs Global Scope 웹툰](./img/scope_king_vs_peasant_webtoon.png)
...
![Local Scope 생명주기 애니메이션](./img/local_scope_anim.svg)
...
![Global Keyword 오버라이드 애니메이션](./img/global_override_anim.svg)
