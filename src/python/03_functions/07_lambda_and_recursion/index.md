---
layout: python
title: "3.3.7 람다(Lambda)와 재귀(Recursion)"
---

# 3.3.7 람다(Lambda)와 재귀(Recursion)

## 학습목표
본 장에서는 초급자를 벗어나 중급자로 도약하는 두 가지 거대한 산을 넘습니다. 첫째는 수학자 알론조 처치에서 유래한 일회용 익명 함수인 **람다(Lambda)**의 극강의 활용도를 해부하고, 둘째는 함수가 거울 속의 자신을 보듯 자기 자신을 끝없이 호출하는 마법 같은 패턴이자, 파일 탐색기의 근간이 되는 **재귀(Recursion)**의 원리를 상세히 정복합니다.
...
## 3. 궁극의 마법: 재귀 함수 (Recursive Functions)
