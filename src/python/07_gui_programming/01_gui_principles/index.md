...
description: "수만 줄의 복잡한 로직을 짜더라도, 결국 일반 고객(User)은 터미널의 까만 화면을 이해하지 못합니다. 본 장에서는 코드가 한 번 실행되고 멈추는 터미널과 달리, 무한의 시간 속에서 마우스 클릭을 대기하는 이벤트 드리븐(Event-Driven) 방식의 철학을 확립합니다...."
---
