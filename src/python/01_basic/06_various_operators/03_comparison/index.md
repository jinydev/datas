...
description: "비교 연산자는 두 값의 관계를 평가하여 논리형 데이터인 True 또는 False를 결과로 남깁니다. 마치 두 개의 값을 양팔 저울에 올려두고 한쪽이 무거운지 같은지를 재는 것과 같습니다. 이 연산자들은 뒤에서 배울 조건문(if)과 반복문(while)에서 '어느 쪽으로 흐를..."
---
