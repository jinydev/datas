...
description: "for문 여러 줄을 사용해 딕셔너리 금고를 하나씩 채우던 원시적이고 장황한 코드를 버리고, 파이썬 특유의 압축 기술인 컴프리헨션(Comprehension) 과 여러 리스트의 짝을 찾아 지퍼(Zip)를 채우는 zip() 함수를 결합하여 단 한 줄 만에 대형 딕셔너리를 생산하..."
---
