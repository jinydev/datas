...
description: "1차원 선(Vector) 여러 개를 차곡차곡 쌓아 올려 2차원 평면(Plane)을 만드는 파이썬 중첩 리스트 기술을 습득합니다. 이는 수학 교과서에서 배우는 행렬(Matrix) 개념과 완벽히 일치하며, 엑셀 표의 행/열 데이터를 처리하거나 고전 보드게임을 개발하는 핵심 좌..."
---
