...
description: "math_story의 차원(Dimension) 개념과 파이썬 데이터 구조를 연결합니다. 가장 기초적인 파이썬의 단일 리스트 [ ] 구조가 수학적으로 어떻게 방향성을 지닌 1차원 벡터(Vector)로 매핑되는지, 컴퓨터가 데이터를 어떻게 기찻길(선) 위의 개미처럼 인식하는지..."
---
