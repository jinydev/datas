...
description: "본 장에서는 지저분한 원본 데이터를 깨끗하게 다듬는 전처리(Data Cleaning) 과정과, 그 데이터 속에 숨겨진 힌트를 찾아내는 탐색적 데이터 분석(EDA)의 역할을 배웁니다. 아울러 사람이 직접 규칙을 짜주던 전통적 코딩에서 벗어나, 기계가 스스로 패턴을 찾아내는 ..."
---
