...
layout: intro
title: "1.5.1 개요 및 도입"
description: "본 장에서는 범주형 데이터의 핵심 축인 명목형(Nominal) 데이터와 서열형(Ordinal) 데이터를 명확히 구분하고 이해합니다. 숫자로 단지 '기호'만 부여한 명목형과, '순서'는 존재하지만 그 간격이 일정치 않은 서열형 데이터의 특성을 파악하여 데이터 전처리 시 발생..."
---
