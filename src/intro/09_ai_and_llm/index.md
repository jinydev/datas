...
description: "본 장에서는 데이터라는 막강한 밥(연료)을 먹고 성장하여 이제는 새로운 지식을 무에서 유로 창조해 내는 인공지능(AI)과 생성형 AI(Generative AI)의 진화 과정을 이해합니다. 나아가 세상을 뒤흔든 챗GPT의 두뇌, 대규모 언어 모델(LLM)의 작동 원리를 파악..."
---
