...
description: "앞선 6.3.1 장에서는 데이터프레임에 바로 df['컬럼명'] 형태의 대괄호를 써서 열(Column)을 뽑아보았습니다. 하지만 판다스의 정석적인 행렬 참조 문법인 .loc[행, 열] 구조에서는, 앞쪽 '행(Row)' 자리에 모든 것을 의미하는 콜론(:) 와일드카드를 배치함..."
---
