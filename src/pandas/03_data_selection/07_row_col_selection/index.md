...
**[비유로 이해하기: 십자선(Crosshair)으로 조준하기]**
...
![loc 십자선 투영 참조 애니메이션](img/row_col_selection.svg)
...
### [2단계] 특정 열만 지정하고, 행은 여러 명 뽑기 (Series 반환)
...
### [3단계] 진정한 부분집합 행렬 뜯어내기 (DataFrame 반환)
