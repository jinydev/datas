...
**[비유로 이해하기: 수많은 서랍장 중 원하는 서랍만 당겨보기]**
...
![DataFrame 열 추출](img/column_selection.svg)
...
### [2단계] 두 과목 이상 동시에 묶어서 뽑기 (다중 열 참조)
...
### [3단계] 팁: 하나를 뽑더라도 표 모양(DataFrame) 살리기
