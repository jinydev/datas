...
![loc 열 우회 검색 애니메이션](img/col_selection_loc_i.svg)
...
### [2단계] 특정 범위의 열(Column) 그룹 뭉터기로 뽑기 (슬라이싱)
