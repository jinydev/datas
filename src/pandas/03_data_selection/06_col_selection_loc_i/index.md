...
description: "6.3.4 장에서 .index 배열을 잘라 .loc에 밀어 넣었듯, 두 번째 축(Axis 1)의 레이블 배열인 .columns 속성을 활용해 열(Column) 이름을 동적으로 추출하여 .loc의 두 번째 파라미터 자리에 던져주는 간접 메모리 오프셋 참조(Indirect O..."
---
