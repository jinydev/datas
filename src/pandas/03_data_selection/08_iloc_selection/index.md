...
description: ".loc가 \"문자열 레이블(이름표)\"라는 사람 친화적인 메타데이터를 기반으로 데이터를 투영했다면, .iloc (Integer Location) 은 내부적으로 연속 할당된 메모리의 물리적 좌표(0, 1, 2... 순서)를 사용하여 직접 접근하는 방식입니다. C언어나 기본 파..."
---
