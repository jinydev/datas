...
description: "인터넷 웹페이지나 공공 구청에서 제공하는 CSV 파일들은 컴퓨터 친화적이기보다는 사람 눈에 보기 좋게 타이틀 제목을 넣거나 숫자 3자리마다 콤마(,)를 찍어두는 경우가 많습니다. 판다스 엔진이 이러한 문자열(String) 형태의 숫자를 산술 연산 체계(Integer/Flo..."
---
...
### 1단계: thousands 옵션을 이용한 파싱 및 형변환
...
새로운 실습을 위해 `pandas_02.py` 파일을 생성합니다. 데이터 파싱 코드를 상단에 복사한 뒤 실습을 진행합니다.

### 1단계: Seaborn을 이용한 시각화 연계
