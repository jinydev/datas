...
**[비유로 이해하기: 학급 성적표 석차 매기기와 요약 보고서]**
...
![Series 정렬의 두 가지 기준: 값 vs 인덱스](./img/series_sort.svg)
