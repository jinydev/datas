...
**[수학적 의미: 열 공간(Column Space) 및 차원의 확장]**
...
![데이터프레임 파생 열 할당 애니메이션](img/df_modify_assign.svg)
...
### [2단계] 새로운 파생 열(Column)으로 할당(대입)하기
