...
* [4.7.1 배열 평탄화 (ravel)](07_shape_memory/01_reshape_ravel/)
* [4.7.2 대칭 반전과 축 교환 (Transpose & Swapaxes)](07_shape_memory/02_transpose_swapaxes/)
* [4.7.3 메모리 뷰 (View)와 얕은 복사](07_shape_memory/03_view/)
* [4.7.4 독립적 복사본 (Copy)과 base 추적](07_shape_memory/04_copy/)
