---
layout: numpy
title: "4.2.5 선형 변환 마법진 (벡터의 왜곡)"
description: "숫자들이 갇힌 감옥(행렬)이 어떻게 \"방향성을 지닌 화살표 빔(벡터, Vector)\"과 결합하여 물리적 모니터 공간이나 게임 세계 전체를 돌리고, 늘리고, 찌그러뜨리는 '물리/그래픽 변환 엔진'으로 돌변하는지 시각적으로 이해합니다."
---

# 4.2.5 시공간을 비틀어라! 선형 변환 (Linear Transformation)
