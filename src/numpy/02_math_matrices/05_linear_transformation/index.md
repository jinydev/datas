...
![Linear Transform Spell Webtoon](./img/linear_transform_spell.png)
*(웹툰 비유: 평평하고 모범적인 2D 게임 모눈종이 격자판 위에 로봇 마법사가 나타나, 빛나는 2x2 숫자 스펠(행렬) 마법진을 땅에 쾅! 하고 내리찍습니다. 그러자 바닥 격자가 대각선으로 고무줄처럼 주욱 늘어나고 심하게 회전하며 찌그러지면서 시공간이 마구 왜곡되는(선형 변환) 역동적이고 유머러스한 장면.)*
