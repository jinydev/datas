---
layout: numpy
title: "4.2.0 왜 갑자기 행렬인가? (방정식의 한계)"
description: "본 장에서는 \"왜 데이터 과학과 파이썬 코딩을 배우는데 갑자기 수학 시간에 포기했던 '행렬' 그림이 튀어나오는가?\"에 대한 근본적인 의문을 해결합니다."
---
...
### 규칙의 발견
식을 여러 개 적다 보니, 어차피 변수들의 순서($x_1, x_2, x_3...$)는 항상 `똑같은 줄`에 있다는 걸 발견한 거죠. 
