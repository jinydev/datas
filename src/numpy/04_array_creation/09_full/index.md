...
하지만 항상 0이나 1만 필요한 것은 아닙니다. 

**"이 표를 전부 행운의 숫자 7로 채워줘!"**, **"모든 칸을 '비어있음(-1)' 상태로 한 번에 세팅해 줘!"**와 같이, 내가 원하는 특정한 값 하나로 거대한 메모리 공간을 단숨에 도배하고 싶을 때 사용하는 '강력한 만능 도장기'가 바로 `np.full()`입니다.
