---
layout: numpy
title: "4.1.4 방정식이 폭발할 때, 행렬이 강림하다"
description: "지금까지 배운 $x, y, z$의 단출한 방정식 스토리가, 변수가 기하급수적으로 늘어나는 AI 딥러닝과 코딩의 시대로 확장되며 어떻게 붕괴 직전에 이르는지 절감합니다."
---

# 4.1.4 방정식이 폭발할 때, 행렬이 강림하다 (Numpy 브릿지)
