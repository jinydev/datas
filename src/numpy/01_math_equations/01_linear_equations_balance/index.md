...
1. **상수 버리기 (똑같이 빼기)**: 왼쪽 접시에 있는 3kg 짜리 추가 눈엣가시입니다. 
...
2. **계수 분할하기 (똑같이 나누기)**: 난 수박 2통이 아니라 "1통"이 궁금합니다. 
...
> 갇혀 있는 $X$ 기호 아바타 주변의 바위(상수) 감옥을 부수기 위해, SWAT 복장을 한 학생이 반대쪽 방호벽에 마법 폭탄(-3, ÷2 연산)을 던지며 철거 밸런스를 맞추는 역동적인 철거 작전 폭발 씬

이 조작의 즐거움도 잠시, 사과만 팔던 장수에게 포도($y$)라는 새로운 변수가 들어오면 우리는 새로운 위기를 맞이합니다. 

식 하나로는 수평을 맞출 수 없는 '연립'의 세계 02장에서 그 교차점을 쏴 맞춰보겠습니다.
