...
*(웹툰 비유: 거대한 황금 양팔 저울 위에 수박 2통과 3kg 추가, 반대쪽엔 11kg 추가 완벽히 수평을 이루고 있고, 진땀을 흘리는 학생이 엄지를 치켜드는 모습)*
...
*(웹툰 비유: 갇혀 있는 $X$ 기호 아바타 주변의 바위(상수) 감옥을 부수기 위해, SWAT 복장을 한 학생이 반대쪽 방호벽에 마법 폭탄(-3, ÷2 연산)을 던지며 철거 밸런스를 맞추는 역동적인 철거 작전 폭발 씬)*
